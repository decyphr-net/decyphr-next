  ...
  return (
    <article className={styles.about}>
      ...
      <section>
        ...
        <img className={styles.rightImg} src="/languages.jpg" />
      </section>

      <section>
        <img className={styles.leftImg} src="/bookstack.jpg" />
        <div className={styles.rightText}>
          <h2>
            <FormattedMessage id="Index.about.firstheader" defaultMessage="Why Use Decyphr?" /></h2>
          <p>
            <FormattedMessage id="Index.about.firstparagraph" defaultMessage="Decyphr was built to help you translate text from the language that your are learning in to your own native language." />
          </p>
          <p>
